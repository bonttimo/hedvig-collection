            ...
            <Content>
                ...
                <Main>
                    <section id="refund-policy">
                        ...
                        <div className="set">
                            <h6>Refunds</h6>
                            <p>Once your return is received and inspected, we will send you an email to notify you that we have received your returned item. We will also notify you of the approval or rejection of your refund. Unfortunately, HEDVIG cannot offer free returns at this time. However, we will refund return costs if the product we have sent you is incorrect or faulty. Refund times depend on your credit or debit card company.</p>
                    ...
                    <section id="privacy-policy">
                        ...
                        <div className="set">
                            ...
                            <p>
                                As described above, we use your Personal Information to provide you with targeted advertisements or marketing communications we believe may be of interest to you. For more information about how targeted advertising works, you can visit the Network Advertising Initiative’s (“NAI”) educational page at <a href="http://www.networkadvertising.org/understanding-online-advertising/how-does-it-work."> Understanding online advertising</a>
                            </p>
                    ...
                    <section id="terms-of-service">
                        ...
                        <div className="set">
                            ...
                            <p>
                                We reserve the right to refuse any order you place with us. We may, in our sole discretion, limit or cancel quantities purchased per person, per household or per order. These restrictions may include orders placed by or under the same customer account, the same credit card, and/or orders that use the same billing and/or shipping address. If we make a change to or cancel an order, we may attempt to notify you by contacting the email and/or billing address/phone number provided at the time the order was made. We reserve the right to limit or prohibit orders that,
                        ...
                        <div className="set">
                            ...
                            <p>You agree to indemnify, defend and hold harmless HEDVIG and our parent, subsidiaries, affiliates, partners, officers, directors, agents, contractors, licensors, service providers, subcontractors, suppliers, interns and employees, harmless from any claim or demand, including reasonable attorneys’ fees, made by any third-party due to or arising out of your breach of these Terms of Service or the documents they incorporate by reference, or your violation of any law or the rights of a third-party.</p>
                        </div>
                        ...
                        <div className="set">
                            ...
                            <p>
                                The failure of us to exercise or enforce any right or provision of these Terms of Service shall not constitute a waiver of such right or provision. These Terms of Service and any policies or operating rules posted by us on this site or in respect to The Service constitutes the entire agreement and understanding between you and us and govern your use of the Service, superseding any prior or contemporaneous agreements, communications, and proposals, whether oral or written, between you and us (including, but not limited to, any prior versions of the Terms of
                    ...
                    <section id="shipping-and-deliveries">
                        <div className="set">
                            ...
                            <p>We are based in Finland and all our products are shipped from our Helsinki studio to the customer.</p>
                            <p>Shipping to Finland:</p>
                            <ul>
                                <li>Posti & PostNord: 6 € (delivery time 5-7 business days)</li>
                                <li>Shipping to close Eu region (Denmark, Estonia, Latvia, Lithuania & Sweden): PostNord 10e (delivery time 5-7 business days)</li>
                            </ul>
                            <p>Shipping to EU region (Austria, Belgium, Bulgaria, Croatia, Cyprus, Czechia, France, Germany, Greece, Hungary, Ireland, Italy, Luxembourg, Monaco, Netherlands, Poland, Portugal, Romania, Slovakia, Slovenia & Spain):</p>
                            <ul>
                                <li>UPS Express Saver 15e (delivery time 5-7 business days)</li>
                                <li>UPS Standard 20e (delivery time 5-10 business days)</li>
                            </ul>
                        </div>
                    </section>
                </Main>
