    ...
    return (
        <Container className="page-privacy-policy" initial="enter" animate="animate" exit="exit" variants={pageTransition}>
            <Content>
                ...
                <Main>
                    <section>
                        <div id="refund-policy" className="item">
                            <h6>Returns</h6>
                    ...
                    <section>
                        <div id="privacy-policy" className="item">
                    ...
                    <section>
                        <div id="terms-of-service" className="item">
                            ...
                            <em>Your submission of personal information through the store is governed by our Privacy Policy. To view our Privacy Policy.</em>
                            ...
                            <p>
                                In no case shall ennos-studio, our directors, officers, employees, affiliates, agents, contractors, interns, suppliers, service providers or licensors be liable for any injury, loss, claim, or any direct, indirect, incidental, punitive, special, or consequential damages of any kind, including, without limitation lost profits, lost revenue, lost savings, loss of data, replacement costs, or any similar damages, whether based in contract, tort (including negligence), strict liability or otherwise, arising from your use of any of the service or any products procured
                            ...
                            <p>Questions about the Terms of Service should be sent to us at info@hedvigcollection.com</p>
                        </div>
                    </section>
                    <section>
                        <div id="shipping-and-deliveries" className="item">
                            ...
                            <ul>
                                ...
                                <li>Posti & PostNord: 6 € (delivery time 2-3 business days)</li>
                                <li>Shipping to close Eu region (Denmark, Estonia, Latvia, Lithuania & Sweden): </li>
